window.addEventListener("load", cargaPagina);
	...
	function cargaPagina (){
		...
		$("#selector").on("change", seleccionarOpcion);
	}
	...
	function texto(){
		...
		botonCerrar.classList.add("waves-effect","waves-light","btn");
		botonPublicar.classList.add("waves-effect","waves-light","btn");
	...
	function meme() {
		...
		botonPublicar.addEventListener("click", imagen);
		botonCerrar.addEventListener("click", cerrar);
	}
	function pastilla() {
		var contenedor = document.createElement("div");
	...
	function imagen() {
		 var inputUrl = document.createElement("img");
            inputUrl.setAttribute("src",this.parentElement.children[0].value);
            cajaSelector.appendChild(contenedorPublicacion);
            contenedorPublicacion.appendChild(inputUrl);
	}
	function eliminar () {
